...
const commonTheme = {
  ...
  blue: colors.blueVibrant,
  blueBG: colors.blue50,
  green: colors.greenVibrant,
  greenBG: colors.green50,
  yellow: colors.yellowVibrant,
  purple: colors.purple300,
  textOrange: colors.textOrange,
  floatPurple: colors.purple900,
  imageGreen: colors.greenVibrant,
...
export const lightTheme = {
  ...
  backgroundSurface: opacify(30, colors.gray50),
  ...
  // backgroundFloatForeground: opacify(30, colors.gray900),

  strokeSurface: colors.gray200,

  strokeFloating: colors.gray200,

  backgroundSelected: opacify(24, colors.gray200),

  transparent: 'transparent',

  blockBorder: colors.gray100,

  text1: colors.gray200,
  text2: colors.gray350,
  text3: colors.gray600,
  text4: colors.gray500,
  text5: colors.gray400,
